...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "0713145618"],
global.ownername = process.env.OWNER_NAME || "Ongeri Brian",
global.ytname = "YT: AyushBotz.inc"
global.socialm = "GitHub: Ongeri-brian"
global.location = "Kenya"

global.botname = process.env.BOTNAME || "𝐌𝐀𝐑𝐈𝐀-𝐌𝐃",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "Ongeri💜Brian",
global.packname = 'Sticker By'
global.author = process.env.AUTHOR || "Ongeri Brian",
//console view/theme
global.themeemoji = '🧩'
...
sessionId: process.env.id || " _M_A_R_I_A_QW5nbGVzU3RhbXBlZAo=", // paste your session id here
